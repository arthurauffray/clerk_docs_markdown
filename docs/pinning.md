...
> Learn how to pin a Clerk SDK to a specific version.
...
// Filename: package.json
   ...
   "@clerk/nextjs": "1.1.0"
   ```
1. Set the `clerkJsVersion` property when you initialize the Clerk integration. For most SDKs, this is done in the `` component. For SDKs like Astro or Nuxt, this is done in the configuration file.
   ```tsx
