...
> Install the Clerk Android SDK with Gradle.
...
> [!NOTE]
> If you don't want to use Clerk's [prebuilt views](/reference/views/overview), you can just add `clerk-android-api`.
...
## Next steps
  ...
  - [Configure the SDK](/android/reference/native-mobile/configuration)
