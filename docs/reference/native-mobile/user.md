...
> Manage the signed-in user with the Clerk Android SDK.
...
Create an external account with an OAuth provider (e.g., Google, GitHub, see [all providers](/guides/configure/auth-strategies/social-connections/overview#supported-social-providers)):
