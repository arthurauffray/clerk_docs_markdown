...
> Learn how to handle sign-in, sign-up, MFA, password reset, and session management with the Clerk iOS SDK.
...
See the [Sign in with Apple guide](/guides/configure/auth-strategies/sign-in-with-apple) for native iOS setup.
...
Sign in using [Enterprise SSO](/guides/configure/auth-strategies/enterprise-connections/overview):
...
Authenticate with an OAuth provider (e.g., Google, GitHub, see [all providers](/guides/configure/auth-strategies/social-connections/overview#supported-social-providers)):
...
Sign up using [Enterprise SSO](/guides/configure/auth-strategies/enterprise-connections/overview):
