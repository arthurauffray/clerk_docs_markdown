...
> Use Clerk in your Android app with global access and reactive state flows.

`Clerk` is the main entry point for the SDK. After you [configure the SDK](/reference/native-mobile/configuration), you can access it in two ways:
