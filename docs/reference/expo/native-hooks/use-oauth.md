...
> Clerk's useOAuth() hook is used to create a new OAuth flow.

> [!WARNING]
> This feature is deprecated. Use [`useSSO()`](/reference/expo/native-hooks/use-sso) instead.
...
The following example demonstrates how to create a custom OAuth sign-in flow for [Google accounts](/guides/configure/auth-strategies/social-connections/google).
