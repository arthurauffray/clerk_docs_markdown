...
> Access and manage the currently Active Organization in your Vue application with Clerk's useOrganization() composable.
...
- **`organization`** <code>Ref\<[Organization](/reference/javascript/organization)></code>

  The currently Active Organization.

    ---

- **`membership`** <code>Ref\<[OrganizationMembership](/reference/javascript/types/organization-membership)></code>
...
Use `useOrganization()` to access the current active [`Organization`](/reference/javascript/organization) object.
