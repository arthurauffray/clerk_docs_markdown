...
- **`publishableKey`** `string`
  ...
  Your Clerk Publishable Key. It's recommended to use [the environment variable](/guides/development/clerk-environment-variables#clerk-publishable-and-secret-keys) instead.

    ---

- **`secretKey?`** `string`

  Your Clerk Secret Key. It's recommended to use [the environment variable](/guides/development/clerk-environment-variables#clerk-publishable-and-secret-keys) instead.
