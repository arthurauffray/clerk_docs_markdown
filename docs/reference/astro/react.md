...
> Learn how to user Clerk inside an Astro app with React
...
If you have not set up your Astro application to work with Clerk, see the [quickstart guide](/astro/getting-started/quickstart).
...
// Filename: astro.config.mjs
  ...
  You can use the [prebuilt components](/reference/components/overview) in your Astro pages or regular React components.
  ...
  ```astro
// Filename: src/layouts/SiteLayout.astro
...
// Filename: src/components/Header.tsx
  ...
  Clerk Astro provides a set of useful [stores](/reference/astro/overview#client-side-helpers) that give you access to the [`Clerk`](/reference/javascript/clerk) object, and helper methods for signing in and signing up.
...
Learn more about Clerk's client-side helpers and how to use them in your Astro app.
  ...
  - [Client-side helpers](/reference/astro/overview#client-side-helpers)
