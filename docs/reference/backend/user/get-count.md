...
This method in the SDK is a wrapper around the BAPI endpoint `GET/users/count`. See the [BAPI reference](/reference/backend-api/tag/users/get/users/count) for more information.
