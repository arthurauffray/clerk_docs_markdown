...
The following example demonstrates how to revoke an Organization invitation. It first gets the list of Organization invitations using [`getInvitations()`](/reference/javascript/organization#get-invitations) and then revokes the first invitation in the list.

It assumes:

- you have followed the [quickstart](/js-frontend/getting-started/quickstart) in order to add Clerk to your JavaScript application
- you have [enabled the Organizations feature in the Clerk Dashboard](/guides/organizations/configure#enable-organizations)
