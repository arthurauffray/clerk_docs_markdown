...
> Add authentication and user management to your JavaScript app with Clerk.

To add the [JavaScript SDK](/reference/javascript/overview) to your JavaScript app, you have two options:
...
#### <script>
      ...
      The [Clerk JavaScript SDK](/reference/javascript/overview) gives you access to a set of classes and methods to make user authentication easier.
...
// Filename: .env
      ...
      To initialize Clerk, add the following code to your `main.js` file. This code imports your Publishable Key, creates a new [`Clerk`](/reference/javascript/clerk) instance, and calls the [`load()`](/reference/javascript/clerk#load) method to initialize Clerk.
...
// Filename: src/main.js
      ...
      Clerk's [prebuilt components](/reference/components/overview) are the easiest way to add authentication and user management to your app. They come styled out-of-the-box and are customizable to fit your app's design.

      To get started, add the following components to your app:

      - [``](/reference/components/authentication/sign-in): Renders a user interface for signing in.
...
<!-- Filename: index.html -->
      ...
      Below the `<script`> tag that initializes the SDK, create another `<script>` tag that listens for the `load` event and call Clerk's [`load()`](/reference/javascript/clerk#load) method to load the SDK, as shown in the following example:
...
Learn more about Clerk components, how to customize them, and how to use Clerk's JavaScript classes using the following guides.
  ...
  - [Create a custom sign-in flow with MFA](/guides/development/custom-flows/authentication/multi-factor-authentication)
  - Learn how to build a custom sign-in flow with multi-factor authentication.

  ---

  - [Clerk class reference](/reference/javascript/clerk)
  - Learn more about the `Clerk` class and how to use it.

  ---

  - [Clerk JavaScript SDK Reference](/reference/javascript/overview)
