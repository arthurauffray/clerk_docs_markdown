...
> See the getting started guides and tutorials.
...
## Frontend
  ...
  - [Chrome Extension (Plasmo)](/chrome-extension/getting-started/quickstart)
  - Use the Chrome Extension SDK with Plasmo to authenticate users in your Chrome extension.
  - ---

  - [Chrome Extension (JavaScript)](/chrome-extension/getting-started/quickstart/chrome-extension-js)
