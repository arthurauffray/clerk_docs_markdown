...
> Learn how to use the Clerk Dashboard to manage your application settings, users, and more.
...
- The [``](/reference/components/user/user-button): Allows you to manage your account and sign out.
...
Each Clerk application can have two different instances: `Development` or `Production`. The names are self-explanatory, but you can learn more about the differences between the two in the [dedicated guide](/guides/development/managing-environments).
