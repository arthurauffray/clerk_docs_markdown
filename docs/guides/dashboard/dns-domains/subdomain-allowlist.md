...
> Restrict which subdomains can make cross-domain requests to the Frontend API for stronger security.

By default, Clerk supports [authentication across subdomains](/guides/development/deployment/production#authentication-across-subdomains). When you configure a root domain for production, your application and the [Frontend API](/reference/frontend-api) (FAPI) can communicate across all subdomains of that domain. To enable this, FAPI accepts cross-origin requests from **any** subdomain of your root domain.
