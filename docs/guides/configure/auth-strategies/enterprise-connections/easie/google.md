...
> Learn how to allow users to sign up and sign in to your Clerk app with their Google account using EASIE SSO.

Enabling [EASIE SSO](/guides/configure/auth-strategies/enterprise-connections/overview#easie) with Google allows your users to sign up and sign in to your Clerk application with their Google account.
...
> [!NOTE]
> If you already [configured Google as a social provider](/guides/configure/auth-strategies/social-connections/google), you can skip this step. EASIE SSO will automatically use the credentials you configured for your social connection.
