...
> Learn how to use OAuth with Clerk to grant granular permissions and manage access securely.
...
> [!NOTE]
> If you would like to know more about the terminology around OAuth, check out the [OAuth terminology guide](/guides/configure/auth-strategies/oauth/overview#key-terminology).
...
# Filename: terminal
  ...
  >
  > By default, the consent screen is shown for all newly created OAuth apps, but this can be disabled in each app's settings [in the Clerk Dashboard](https://dashboard.clerk.com/~/oauth-applications), although not recommended. [Learn more about how Clerk's OAuth consent screen works](/guides/configure/auth-strategies/oauth/how-clerk-implements-oauth#consent-screen-management).
