...
> Learn how to allow users to sign up and sign in to your Clerk app with their Apple ID using OAuth.
...
> [!IMPORTANT]
> This guide explains how to configure Sign in with Apple for web-based flows. To configure Sign in with Apple on native applications (such as iOS or Expo apps), see the [dedicated guide](/guides/configure/auth-strategies/sign-in-with-apple).
...
To make the setup process easier, it's recommended to keep two browser tabs open: one for your [Clerk Dashboard](https://dashboard.clerk.com/~/user-authentication/sso-connections) and one for your [Apple Developer dashboard](https://developer.apple.com/account).
  ...
  1. Save the **Email Source for Apple Private Email Relay** and **Return URL** values somewhere secure, as you'll need to provide them to Apple later. Keep this page open.
