...
> Learn how to allow users to sign up and sign in to your Clerk app with their TikTok account using OAuth.
...
To make the setup process easier, it's recommended to keep two browser tabs open: one for the [Clerk Dashboard](https://dashboard.clerk.com/~/user-authentication/sso-connections) and one for your [TikTok Developer Portal](https://developers.tiktok.com/).
  ...
  1. Select **TikTok** from the provider list.
  1. Ensure that both **Enable for sign-up and sign-in** and **Use custom credentials** are toggled on. Keep this page open.
