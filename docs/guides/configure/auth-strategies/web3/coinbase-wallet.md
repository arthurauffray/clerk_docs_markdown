...
> Learn how to set up Web3 authentication with Coinbase Wallet.
...
> [!WARNING]
> This guide is for using Coinbase Wallet for authentication. If you're looking to connect users using [Coinbase.com](https://www.coinbase.com/) as a social provider, see the [dedicated guide](/guides/configure/auth-strategies/social-connections/coinbase).
...
The simplest way to test authentication is to visit your Clerk application's [Account Portal](/guides/account-portal/overview), which is available for all Clerk applications out-of-the-box.
...
Users can connect their Coinbase Wallet to their account at any time through their user profile page. You can configure your application to use the [Account Portal user profile page](/guides/account-portal/overview#user-profile) or the prebuilt [``](/reference/components/user/user-profile) component.
