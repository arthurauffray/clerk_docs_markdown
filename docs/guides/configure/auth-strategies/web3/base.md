...
> Learn how to set up Web3 authentication with Base.
...
1. From the list of web3 providers, enable **Base**.
...
1. On the sign-in page, you should see **Base** as an option. Use it to sign in.
...
Users can connect their Base account to their account at any time through their user profile page. You can configure your application to use the [Account Portal user profile page](/guides/account-portal/overview#user-profile) or the prebuilt [``](/reference/components/user/user-profile) component.
