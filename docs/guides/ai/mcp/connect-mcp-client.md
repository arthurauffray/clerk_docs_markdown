# Connect MCP-compatible clients to your MCP server


> Learn how to connect MCP-compatible clients, like Cursor, to your MCP server

This guide demonstrates how to connect an MCP-compatible client (**LLM app**), like Cursor, to an MCP server. It assumes that you have already built an MCP server in your application with Clerk by following the guide on [building an MCP server](/guides/ai/mcp/build-mcp-server).
