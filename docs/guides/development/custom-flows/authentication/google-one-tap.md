...
> Learn how to build a custom Google One Tap authentication flow using the Clerk API.
...
This guide will walk you through how to build a custom Google One Tap authentication flow.
  ...
  To use Google One Tap with Clerk, follow the steps in the [dedicated guide](/guides/configure/auth-strategies/social-connections/google#configure-for-your-production-instance) to configure Google as a social connection in the Clerk Dashboard using custom credentials.
...
> Examples for this SDK aren't available yet. For now, try adapting the  available example to fit your SDK.
  ...
  ```tsx
// Filename: app/components/CustomGoogleOneTap.tsx
  ...
  ```tsx
// Filename: app/google-sign-in-example/page.tsx
