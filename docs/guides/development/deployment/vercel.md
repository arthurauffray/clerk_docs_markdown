...
> Learn how to deploy a Clerk app to Vercel.

> [!WARNING]
> This guide assumes that you have already installed Clerk in your application locally and are ready to deploy. If you haven't installed Clerk yet, see the [setup guide](/getting-started/quickstart/setup-clerk).
...
> [!WARNING]
> If you would like to deploy to production, you will need to add your **production** API keys to your Vercel project. Refer to the [Deploy to production](/guides/development/deployment/production) guide for more information.
...
To configure Clerk within your Vercel preview environment, see the [guide for configuring a preview environment](/guides/development/managing-environments).

## Deploy to production

If you would like to deploy your Vercel project to production, you will need to add your **production** API keys to your Vercel project. You will also need a domain that you own, as you cannot use a `*.vercel.app` domain for production. Refer to the [Deploy to production](/guides/development/deployment/production) guide for more information.
