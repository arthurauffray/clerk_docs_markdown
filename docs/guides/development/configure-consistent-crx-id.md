...
> Learn how to configure a consistent CRX ID in your Chrome Extension.
...
> [!WARNING]
> If you followed the [Chrome Extension Quickstart](/chrome-extension/getting-started/quickstart), you have already completed this configuration.
