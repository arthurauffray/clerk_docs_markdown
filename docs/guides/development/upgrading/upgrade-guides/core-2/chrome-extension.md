...
> Learn how to upgrade Clerk's Chrome Extension SDK to the latest version.
...
### `tokenCache` → `storageCache` as `` props
...
Organization.logoUrl</code> -&gt; <code>Organization.imageUrl</code>", "<code>User.profileImageUrl</code> -&gt; <code>.imageUrl</code>"]}
>
...
User.update({ password: &#39;x&#39; })</code> -&gt; <code>User.updatePassword(&#39;x&#39;)</code>"]}
>
