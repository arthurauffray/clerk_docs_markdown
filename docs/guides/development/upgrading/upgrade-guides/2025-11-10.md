...
> Learn how to upgrade to version 2025-11-10 of Clerk's API.
...
- **`payment_source`** [BillingPaymentMethodResource](/reference/javascript/types/billing-payment-method-resource)
...
- **`features`** <code>[Feature](/reference/backend/types/feature)\[]</code>
...
- **`plan`** [BillingPlanResource](/reference/javascript/types/billing-plan-resource) | `null`
...
- **`lifetime_paid`** [BillingMoneyAmount](/reference/javascript/types/billing-money-amount)
...
- **`amount`** [BillingMoneyAmount](/reference/javascript/types/billing-money-amount)
...
- **`next_invoice`** [BillingSubscriptionItemResource](/reference/javascript/types/billing-subscription-item-resource)

  The `next_invoice` field has been removed, in favor of the `next_payment` field.

    ---

- **`next_payment`** [BillingSubscriptionItemResource](/reference/javascript/types/billing-subscription-item-resource)

  The `next_payment` field can be omitted when the endpoint doesn't include that data in the response.

    ---

- **`payer`** [BillingPayerResource](/reference/javascript/types/billing-payer-resource)
...
- **`total_due_after_free_trial`** [BillingMoneyAmount](/reference/javascript/types/billing-money-amount) | `null`

  The `total_due_after_free_trial` field can no longer be omitted, and will instead be `null` when it doesn't apply.

    ---

- **`credit`** [BillingMoneyAmount](/reference/javascript/types/billing-money-amount) | `null`

  The `credit` field can no longer be omitted, and will instead be `null` when it doesn't apply.

    ---

- **`past_due`** [BillingMoneyAmount](/reference/javascript/types/billing-money-amount) | `null`

  The `past_due` field can no longer be omitted, and will instead be `null` when it doesn't apply.

    ---

- **`total_due_now`** [BillingMoneyAmount](/reference/javascript/types/billing-money-amount) | `null`

  The `total_due_now` field can no longer be omitted, and will instead be `null` when it doesn't apply.

    ---

- **`proration`** [BillingCheckoutTotals](/reference/javascript/types/billing-checkout-totals) | `null`
