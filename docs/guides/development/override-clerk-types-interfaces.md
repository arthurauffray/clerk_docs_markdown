...
> Learn about the interfaces that you can use to define custom types for your application.
...
- Custom Permissions are merged with [System Permissions](/guides/organizations/control-access/roles-and-permissions#system-permissions)
