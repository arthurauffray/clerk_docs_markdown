...
// Filename: global.setup.ts
  ...
  > [!NOTE]
  > Instead of calling `clerkSetup()`, you can manually set the Testing Token by setting the `CLERK_TESTING_TOKEN` environment variable to the [Testing Token](/guides/development/testing/overview#testing-tokens) that you create through the Backend API.
