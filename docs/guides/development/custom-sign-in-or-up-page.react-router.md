...
> Learn how to add a custom sign-in-or-up page to your React Router app with Clerk's prebuilt components.
...
To set up separate sign-in and sign-up pages, follow this guide, and then follow the [custom sign-up page guide](/react-router/guides/development/custom-sign-up-page).


  ## Build a sign-in-or-up page

  The following example demonstrates how to render the [``](/reference/components/authentication/sign-in) component on a dedicated page using the [React Router Splat route](https://reactrouter.com/start/framework/routing#splats).
