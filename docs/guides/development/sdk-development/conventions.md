...
> A set of agreed standards for building Clerk SDKs.
...
Any environment variable used in the context of Clerk should be prefixed with `CLERK_`. [Learn more about Clerk environment variables](/guides/development/clerk-environment-variables).
...
Additionally, you need to make the environment variables for [API and SDK configuration](/guides/development/clerk-environment-variables#api-and-sdk-configuration) available to your users.
...
Clerk recommends implementing the [sign-in and sign-up redirect](/guides/development/clerk-environment-variables#sign-in-and-sign-up-redirects) environment variables.
...
- If you haven't already, [sign up for an account](https://dashboard.clerk.com/sign-up) and create a new application. Go to the [**API keys**](https://dashboard.clerk.com/~/api-keys) page to retrieve your Publishable Key and/or Secret Key.
...
Here's how the [`@clerk/astro`](/reference/astro/overview) package is using subpath exports:
