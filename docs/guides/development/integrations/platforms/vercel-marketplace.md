...
> Learn how to integrate Clerk into your Vercel projects through the Vercel Marketplace.
...
Refer to the [Configuration documentation](/guides/configure/auth-strategies/sign-up-sign-in-options) for more information on configuring your application.
