...
> Enable Clerk with Google Analytics to authenticate requests to your application.
...
>
> As a workaround, you can implement your own analytics tracking by observing user state changes via Clerk's [`useUser()`](/reference/hooks/use-user) hook and firing events to your analytics provider. See the [FAQ section](#frequently-asked-questions-faq) below for an example.
...
![The Integrations page in the Clerk Dashboard. A red arrow points to the toggle next to 'Google Analytics'.](/images/integrations/google/integrations.webp)

Once enabled, you will be presented with a form to enter the required Google Analytics configuration attributes.

![The Google Analytics configuration form in the Clerk Dashboard.](/images/integrations/google/configuration-settings.webp)
...
![A gif showing how to access the API secret in the Google Analytics UI.](/images/integrations/google/api-secret.gif)
...
![A gif showing how to access the measurement ID in the Google Analytics UI](/images/integrations/google/measurement-id.gif)
...
![A screenshot showing how to find the tracking ID](/images/integrations/google/tracking-id.webp)
...
Yes. You can implement your own analytics tracking by observing user state changes via Clerk's [`useUser()`](/reference/hooks/use-user) hook and firing events to your analytics provider.
...
```tsx
// Filename: src/analytics-tracker.tsx
