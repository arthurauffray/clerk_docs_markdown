...
>
> Learn how to [migrate your Firebase users to Clerk](/guides/development/migrating/firebase).
...
## Next steps
  ...
  - [Use webhooks to sync Firebase data with Clerk](/guides/development/webhooks/syncing)
  - Learn how to sync Firebase auth or Firestore data with Clerk data using webhooks.

  ---

  - [Create a custom sign-in-or-up page in your Next.js app](/nextjs/guides/development/custom-sign-in-or-up-page)
  ...
  - [Deploy to Vercel](/guides/development/deployment/vercel)
