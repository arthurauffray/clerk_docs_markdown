...
> Learn how to integrate Clerk into your Prisma Postgres application.
...
// Filename: app/page.tsx
  ...
  Create a new file called `app/posts/create/page.tsx` and add the following code to it. This page allows users to create new posts. It uses Clerk's [`auth`](/reference/backend/types/auth-object) object to get the user's ID.
