...
> Notify users of unauthorized sign-ins to their accounts
...
- [Account Portal](/guides/account-portal/overview) enabled: The user is redirected to the [unauthorized sign-in](/guides/account-portal/overview#unauthorized-sign-in) page, where content can be customized based on the app's theme.
