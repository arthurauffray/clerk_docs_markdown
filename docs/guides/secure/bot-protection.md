...
> Protect your sign-ups from bots.
...
- If you're building a custom sign-up flow using the Clerk API instead of using Clerk components, and you have enabled **Bot sign-up protection**, then you need to ensure you have added a DOM node to render the CAPTCHA widget. Refer to the [Add bot protection to your custom sign-up flow](/guides/development/custom-flows/authentication/bot-sign-up-protection) guide for more information.
