...
> Learn how to protect the pages in your Clerk + Nuxt application.

This guide demonstrates how to protect pages in your Nuxt application.

> [!TIP]
> To learn how to protect API routes, see the [dedicated guide](/reference/nuxt/clerk-middleware#protect-api-routes).
...
- Uses the `isSignedIn` property returned by the [`useAuth()`](/reference/composables/use-auth) composable to check if the user is signed in.
