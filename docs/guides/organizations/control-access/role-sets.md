...
> Control which Roles are available to each Organization using Role Sets, the foundational building block for organization-level access control.
...
If all Organizations need the same custom Roles, just modify the Primary Role Set instead. Refer to [Roles and Permissions](/guides/organizations/control-access/roles-and-permissions) to learn how.
...
To create additional Role Sets beyond the Primary Role Set, you'll need the [**Enhanced B2B Authentication** add-on](/pricing).
...
Now that you've learned about Role Sets, you can:
  ...
  - [Check access](/guides/organizations/control-access/check-access)
