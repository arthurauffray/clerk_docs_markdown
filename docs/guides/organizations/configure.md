...
> Learn how to configure global Organization settings in the Clerk Dashboard, including pricing, membership limits, and optional features.
...
- **Membership required (default)**: Every user is required to belong to an Organization. All new and existing users will be prompted to create or join an Organization through the [session tasks flow](/guides/configure/session-tasks) before they can access your application. This setting is common for most B2B SaaS. It's recommended to enable the [Create first organization automatically](#create-first-organization-automatically) setting to simplify this process.
...
- **Membership optional**: Users can operate in their own individual workspace or join Organizations. They start in their [Personal Account](#personal-accounts) and can switch to Organizations using the [``](/reference/components/organization/organization-switcher) component. This setting is common for B2C applications moving to B2B.
...
Clerk measures Organizations by Monthly Retained Organizations (MROs). Refer to the [overview page](/guides/organizations/overview#how-do-organizations-work) for pricing details and limits.
...
You can also [use Organization slugs in your application's URLs](/guides/organizations/org-slugs-in-urls).
...
Learn more about [creating Organizations](/guides/organizations/create-and-manage).
...
If you need users to create more than 100 Organizations, [contact support](/contact/support) to have the limit raised.
...
The default role for members is assigned to users when they join an Organization through invitations or Verified Domain enrollment. By default, this is set to [**Member**](/guides/organizations/control-access/roles-and-permissions#default-roles).

This role is used:

- When sending invitations from the [``](/reference/components/organization/organization-profile) component (pre-filled as default)
- When users auto-join via [Verified Domains](/guides/organizations/add-members/verified-domains)
...
Now that you've configured global settings, you can:
  ...
  - [Create your first Organization](/guides/organizations/create-and-manage)
  ...
  - [Control access based on Roles and Permissions](/guides/organizations/control-access/roles-and-permissions)
