...
> Learn how to share direct links to your Account Portal pages, and how to set up fallback redirects.
...
Set the appropriate [environment variables](/guides/development/clerk-environment-variables#api-and-sdk-configuration) to configure the fallback redirects for sign-in and sign-up.

### Sign out

Set the post-sign-out redirect by passing the `afterSignOutUrl` prop to the `` component. See the [reference doc](/reference/components/clerk-provider) for more information.
