# Read session and user data in your Expo app with Clerk


> Learn how to use Clerk's hooks to protect content and read user data in your Expo application.
...
```tsx
// Filename: components/UseAuthExample.tsx
