...
Clerk Billing allows your customers to purchase recurring Subscriptions to your application. To get started, **choose one or combine both of the following** business models depending on your application's needs.
  ...
  - [Billing for B2C SaaS](/guides/billing/for-b2c)
  - To charge individual users

  ---

  - [Billing for B2B SaaS](/guides/billing/for-b2b)
  - To charge companies or organizations

  ---

  - [Webhooks](/guides/development/webhooks/billing)
  - To track Subscription lifecycles and monitor payment attempts

  ---

  - [Build a simple checkout page](/guides/development/custom-flows/billing/checkout-new-payment-method)
...
Yes, Clerk Billing supports custom pricing plans. See [Custom Plans and prices](/guides/billing/custom-plans) for more information.
