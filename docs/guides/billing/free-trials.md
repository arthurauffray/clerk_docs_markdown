...
> Let users try paid Features before subscribing
...
Free trials let your users explore paid [Features](/guides/secure/features) for a limited time for free, helping them build confidence in a purchase decision. With Clerk Billing, you can turn on free trials for any Plan, or set the same trial period across all your Plans.
