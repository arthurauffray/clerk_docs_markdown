...
> Transition Subscriptions between Plans and create custom pricing for your customers
...
For complete API documentation, see the [Create price transition endpoint](/reference/backend-api/tag/billing/post/billing/subscription_items/\{subscription_item_id}/price_transition).
