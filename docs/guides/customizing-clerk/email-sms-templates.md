...
> Learn how to configure the theming of Clerk-sent emails and SMS messages.
...
| `invitation.public_metadata` | The [public metadata](/guides/users/inviting#with-invitation-metadata) of the invitation. |
...
This means that Clerk will no longer be sending this particular SMS and in order to deliver it yourself, you will need to listen to the `sms.created` [webhook](/guides/development/webhooks/overview) and extract the necessary info from the event payload.
