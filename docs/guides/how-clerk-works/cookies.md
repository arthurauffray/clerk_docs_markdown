...
> Learn how cookies enable secure authentication and manage browser-server interactions.
...
- Can be configured by modifying the [session token](/guides/sessions/session-tokens) in the [Clerk Dashboard](https://dashboard.clerk.com/~/jwt-templates).
...
To learn more about how Clerk uses cookies to store user information, see the [guide on how Clerk works](/guides/how-clerk-works/overview).
